    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐱‍👤 cat Ninja Name Service</p>
              <p className="subtitle">FINTECH-Blockchain Project</p>
              <p>Team members: Divya Jnankshi,Meghana H,Hussaina,Kartikeya,Alaric sequeria,Pranav Sampat</p>
            </div>
